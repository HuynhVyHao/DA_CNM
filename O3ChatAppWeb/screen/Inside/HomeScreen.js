...
const HomeScreen = ({ navigation, route }) => {
  ...
  const [avatarUri, setAvatarUri] = useState(user ? user.avatarUrl : require('../../assets/img/iconHomeScreen/Avatar.png'));
...
allowsEditing: true,
  ...
  const updateProfile = async () => {
    try {
      ...
      let avatarUrl = user.avatarUrl; // Giữ nguyên avatarUrl nếu không có hình ảnh mới
    ...
    if (avatarUri) {
      ...
      const params = {
        ...
        UpdateExpression: "SET hoTen = :hoTen, avatarUrl = :avatarUrl, ngaySinh = :ngaySinh, gioiTinh = :gioiTinh",
        ExpressionAttributeValues: {
          ":hoTen": username,
          ":avatarUrl": avatarUrl, 
          ":ngaySinh": birthday,
...
<Pressable onPress={() => setModalSetting(true)}>
        ...
        <View style={styles.middle}>
          <View style={styles.tabMiddle}>
            ...
            <Pressable onPress={() => setModalKetban(true)} 
...
style={styles.txtSearch}
            ...
            />
              ...
              <Pressable style={styles.btnThemban} onPress={() => searchUserByPhoneNumber(phoneNumber)}>
            ...
            <View style={styles.searchResultContainer}>
              {searchText.map((user, index) => (
                <View key={index} style={styles.userItem}>                  
                  ...
                  <Pressable style={styles.addButton} onPress={() => addFriend(user.soDienThoai)}>
