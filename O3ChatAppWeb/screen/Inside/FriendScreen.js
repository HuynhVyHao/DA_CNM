...
import { SafeAreaView, StyleSheet, Text, View, Pressable, Modal, FlatList, Image,ScrollView} from "react-native";
...
const FriendScreen = ({ navigation, user}) => {
  ...
  const handleAcceptFriendRequest = async (friendRequest) => {
    try {
      ...
      const getSenderFriendsParams = {
        TableName: "Friends",
        Key: { soDienThoai: friendRequest.soDienThoai },
      };
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        <Text style={{ fontWeight: "normal", textAlign: "left", fontSize: 20, marginLeft: 10 }}>Lời mời kết bạn</Text>
      </Pressable>
